...
public class AnimalID {
    ...
    public AnimalID(int id, String name, String type, ArrayList commands, String date) {
        setId(id);
        setName(name);
        setType(type);
    ...
    public AnimalID(int id, String name, String type, String commands, String date) {
        setId(id);
        setName(name);
        setType(type);
        setCommands(commands);
    ...
    public AnimalID(String name, String type, ArrayList commands, String date) {
        setName(name);
        setType(type);
        setCommands(commands);
        setDate_of_birth(date);
    ...
    public AnimalID(String name, String type, String commands, String date) {
        setName(name);
        setType(type);
        setCommands(commands);
        setDate_of_birth(date);
    ...
    public AnimalID(Animal animal, String type) {
